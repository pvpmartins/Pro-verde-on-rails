        ...
        <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
          <div class="w-full lg:sticky top-0">
            <div class="flex flex-row gap-2">
              ...
              <div class="flex-1">
                <img :src="'https://imgs.search.brave.com/MHqJNB53D5lbIGkB5udVqIIiieGsJGgBX85NgW5h-X4/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/NTFRY1phM20xLUwu/anBn'" alt="Product"
          ...
          <div class="w-full">
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900 dark:text-gray-100">{{ product.name }}</h3>
              <p class="text-slate-500 mt-2 text-sm dark:text-gray-100">Women Embroidered Georgette A-line Kurta With Attached Dupatta (Maroon)
              </p>
              <div class="flex items-center flex-wrap gap-4 mt-6">
                <h4 class="text-slate-900 text-2xl sm:text-3xl font-semibold dark:text-gray-100">$12</h4>
                <p class="text-slate-500 text-lg dark:text-gray-100"><strike>$16</strike> <span class="text-sm ml-1.5">Tax included</span></p>
              </div>
            ...
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900 dark:text-gray-100">Sizes</h3>
            ...
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900 dark:text-gray-100">Select Delivery Location</h3>
            ...
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900 dark:text-gray-100">Product Information</h3>
              <div class="mt-4" role="accordion">
                <div class="dark:bg-gray-200 dark:hover:bg-gray-100 hover:bg-slate-100 transition-all">
                  <button type="button"
                ...
                <div class="hover:bg-slate-100 transition-all dark:bg-gray-200 dark:hover:bg-gray-100">
                  <button type="button"
                    class="w-full text-sm font-semibold text-left px-4 py-2.5 text-slate-900 flex items-center">
                ...
                <div class="hover:bg-slate-100 transition-all">
                  <button type="button"
                    class="w-full text-sm font-semibold text-left px-4 py-2.5 text-slate-900 flex items-center dark:bg-gray-200 dark:hover:bg-gray-100">
            ...
            <div>
              <h3 class="text-lg sm:text-xl font-semibold text-slate-900 dark:text-gray-100">Customer Reviews</h3>
              ...
              <div class="flex items-center flex-wrap gap-4 mt-4">
                <h4 class="text-2xl sm:text-3xl text-slate-900 font-semibold dark:text-gray-100">4.0 / 5</h4>
            ...
            <div class="mt-6">
              <div class="flex items-start">
                ...
                <div class="ml-3">
                  <h4 class="text-slate-900 text-sm font-semibold dark:text-gray-100">John Doe</h4>
