...
<Main>
    <h1 class="text-[3rem] w-fit mx-auto pb-8">Suas Inscrições</h1>
...
import { Plan, PlanFrequency, Subscription, SubscriptionPlan } from '../../../types';
import { router } from '@inertiajs/vue3';

const props = defineProps<{subscriptions: Subscription[], plan}>()
